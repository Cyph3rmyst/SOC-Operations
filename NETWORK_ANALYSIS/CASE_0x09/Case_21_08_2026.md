...
From the suspicious http traffic obtained of the host "10.8.19.101" downloading a pdf file from http[:]//185[.]244[.]41[.]29/ we can now obtain the pdf file for further analysis:
...
From here we can see that the file is a windows excutable disguised as a pdf, we obtain its hash to analyze it via virus-total _4e4ae70b6346eae111e31716dc76bc23_:

![img](case9_img11.png)

Here we can now see the suspicious pdf file is actually a malicious file named:
